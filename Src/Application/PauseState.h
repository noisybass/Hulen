...
Contiene la declaración del estado de pausa.
...
{
	/**
	Como su nombre indica, esta clase es la clase de la pausa del juego. 
	Es muy sencilla y lo único que hace es cargar
	...
	de la pausa a las funciones C++ que se deben invocar cuando los botones
	son pulsados.
	<p>
	...
	*/
	...
	private:
		...
		/**
		Ventana CEGUI que muestra la pausa.
		*/
